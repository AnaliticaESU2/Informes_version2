...
def seguridad_convenio(df_dict:dict,contrato:str):


    df_seguridad = df_dict["Seguridad_social"].copy()

    df_seguridad = df_seguridad.loc[df_seguridad["Convenio"] == contrato]
